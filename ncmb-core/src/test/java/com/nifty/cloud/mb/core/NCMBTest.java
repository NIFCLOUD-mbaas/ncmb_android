...
public class NCMBTest {
    ...
    public void initialize_with_apiKey() {
        NCMB.initialize(Robolectric.application.getApplicationContext(),"appKey","cliKey");
    ...
    public void initialize_with_apiKey_and_metaData() {
        ...
        when(NCMB.getMetadata(Robolectric.application.getApplicationContext() ,NCMB.METADATA_PREFIX + "DOMAIN_URL")).thenReturn("http://sample.com/");
        when(NCMB.getMetadata(Robolectric.application.getApplicationContext() ,NCMB.METADATA_PREFIX + "API_VERSION")).thenReturn("2015-07-23");
        NCMB.initialize(Robolectric.application.getApplicationContext(),
                "appKey",
                "cliKey");
